...
class Customers
{
	...
	public function addOrder($post_data, $files) {
		...
		$receipt_file_path = 'uploads/' . $receipt_file;
		// Insert order into database
		$stmt = $this->con->prepare("INSERT INTO orders (user_id, product_id, qty, trx_id, p_status, payment_method, receipt_file) VALUES (?, ?, ?, ?, ?, ?, ?)");
		$stmt->bind_param("iiissss", $customer_id, $product_id, $quantity, $transaction_id, $order_status, $payment_method, $receipt_file_path);
